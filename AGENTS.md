# Agent Instructions for Ragoptimizer

## Project Context
Ragoptimizer is an open source Benchmark and optimize RAG pipeline configurations.

## Repository Layout
- `src/aumai_ragoptimizer/` — package source
